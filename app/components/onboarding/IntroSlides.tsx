...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#fff' }, flagLine: { height: 4, flexDirection: 'row' }, flagGreen: { flex: 1, backgroundColor: colors.primary }, flagRed: { width: 48, backgroundColor: colors.red },
